...
- Enemies will spawn in a random location on the screen every X frames,
  where X is defined in the config file.
...
- Any Entity with a lifespan that is currently alive, it should have its Color
...
- You may develop the GUI in any way that constain this functionality, but
...
- This line declares that the SFML Window must be constructed with width W
  ...
  window should be set to, and FS will be an integer whihc specifies whether to
